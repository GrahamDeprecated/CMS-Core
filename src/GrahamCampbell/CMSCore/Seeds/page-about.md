...
7. Additionally, you may to setup some of Bootstrap CMS's other features (see below).  
  ...
  * Also note, without caching asset generation will cause page load delay - to reduce this, turn off minification and caching in `app/config/packages/lightgear/asset`
